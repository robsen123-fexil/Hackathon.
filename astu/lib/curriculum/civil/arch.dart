...
class Archabout extends StatelessWidget {
  final PageController _controller = PageController();
  static String id = 'archabout';
  Archabout({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Architectural Engineering"),
