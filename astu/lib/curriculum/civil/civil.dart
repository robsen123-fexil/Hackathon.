...
class Civilabout extends StatelessWidget {
  final PageController _controller = PageController();
  static String id = 'civilabout';
  Civilabout({super.key});
