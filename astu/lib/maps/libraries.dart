       ...
       body: SingleChildScrollView(
         child: Column(
           children:[ Container(
            ...
            height: MediaQuery.of(context).size.height * 0.5, // Set container height to half of screen height
            child: MapSample(),
                 ),
                 SizedBox( 
                  height: 30,
                 ...
                 Row(children: [
                  Padding(
                    ...
                    child:
                     Text("Central Libraries" , style: TextStyle(fontSize: 20 , ),),
                     )]
                  ) ,
                  Row(
                    children:[ Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: AssetImage('images/central.jpg')),
                  ...
                  Row(children: [
                    Padding
                    (padding: EdgeInsets.all(10),
                      child: Text("Open for 24 hour " ,style: TextStyle(fontSize: 20),)),
                    ]),
                    Row( children: [ 
                      Padding(
                        padding: EdgeInsets.all(10),
                        child: Text("BLOCK 107" , style: TextStyle(fontSize: 20),),
